...
<body>
  ...
  <div class="page-sidebar pagescroll expandit">
     ...
     <div class="show1 ">   
       <div class="add"><b style="margin: 3px;"><h3>Send a message</h3></b></div>
      
       <form class='f'action="../database/massage1.php" method="post">
         <label class="control-label" for="Rollno"><b>Receiver Roll No:</b></label><br>
         <input type="text" id="RollNo" name="RollNo" placeholder="RollNo" class="span8" required autocomplete="off">
         <br>
         <label class="control-label" for="Message"><b>Message:</b></label><br>
         <input type="text" id="Message" name="Message" placeholder="Enter Message" class="span8" required autocomplete="off">
         <br>
         <center>
         <button type="submit" name="massage"class="btn btn-primary">Add Message</button></center>
       </form>
       <br>
