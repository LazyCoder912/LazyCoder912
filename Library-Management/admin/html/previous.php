...
<body>
  ...
  <div class="page-sidebar pagescroll expandit">
     ...
     <div class="show3">
      <form class="form-horizontal row-fluid" action="previous.php" method="post">
        <center><div class="controls">
          <input type="text" id="title" name="title" placeholder="Enter Roll No of Student" required autocomplete="off">
          <button type="submit" name="previous"class="btn btn-success">Search</button>
        </div></center>
        <br>       
        <br>              
      </form>
