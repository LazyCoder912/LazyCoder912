      ...
      <ul>
        ...
        <li > <i class="fa fa-outdent"></i><a href="current.php">Currently Issued Books </a></li>
         <li > <i class="fa fa-backward"></i><a href="previous.php">Previously Issued Books </a></li>
                    ...
                    <div class="show3">
                        <form class="form-horizontal row-fluid" action="renew_requests.php" method="post">
                                      <center><div class="controls">
                                                <input type="text" id="title" name="title" placeholder="Enter Roll No of Student" required>
                                               <button type="submit" name="current"class="btn btn-success">Search</button>
                                            </div></center>
                                 <br>       
                                 <br>              
                     </form>
                     ...
                     if(isset($_POST['current'])){
                                ...
                                <tr>
                                  ...
                                  <td><?php echo $roll; ?></td>
                                  <td><?php echo $da; ?></td>
                                  <td><button type="submit" name="renew"class="btn btn-success">renew</button></td>
                                </tr>
                                <?php
                            }
                                ?>
