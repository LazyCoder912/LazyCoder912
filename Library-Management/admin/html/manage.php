...
<body>
  ...
  <div class="page-sidebar pagescroll expandit">
     ...
     <div class="show1 " >
       <div class="add"><b style="margin: 3px;"><h3>Add Massage</h3></b></div>
       <form class="f" action="../database/Addstudent.php" method="post">
         ...
         <br>
         <label class="control-label" ><b>Roll Number:</b></label><br>
         ...
         <center>
          <div class="send-button">
            <input type="submit" name="Addstudent" value="Add Student" class="btn btn-primary"></div></center>   <br>
          </form>
        </div>
