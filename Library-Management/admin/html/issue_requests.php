...
<body>
  ...
  <div class="show1" >
    ...
    <div class=" text-center add"><b style="margin: 10px;">Issue Book</b></div>
    <form class="f" action="../database/issue.php" method="post">
     <label class="control-label" for="Title"><b>Roll Number</b></label><br>
     <input type="text" id="title" name="roll" placeholder="Roll Number" class="span8" required autocomplete="off"><br>
     
     <label class="control-label" for="Author"><b>book id</b></label><br>
     
     <input type="text" id="author1" name="id" class="span8" required autocomplete="off">
     <br>
